...
frm_select_folder = tk.LabelFrame(master=window, text="Select folder", font="VERDANA")
...
button = tk.Button(master=frm_select_folder, text="Selecionar pasta", font="VERDANA")
...
frm_perform_analysis = tk.LabelFrame(master=window, text="WL analysis", font="VERDANA")
frm_perform_analysis.grid(row=0, column=1)
